...
**🎉 All phases are written** (docs 00–20):

- Phase 0 — Foundations ([00](00-roadmap.md)–[06](06-remote-state-backend.md))
- Phase 1 — Networking ([07](07-networking-vpc-and-subnets.md), [08](08-networking-security-groups-and-nacls.md))
- Phase 2 — Compute ([09](09-compute-launch-template-and-asg.md), [10](10-compute-application-load-balancer.md))
- Phase 3 — Database ([11](11-database-rds-postgresql.md))
- Phase 4 — The Application ([12](12-application-fastapi-backend.md), [13](13-application-deploy-to-ec2.md), [14](14-application-react-frontend.md))
- Phase 5 — Content Delivery ([15](15-content-delivery-s3-cloudfront.md))
- Phase 6 — Serverless ([16](16-serverless-audit-log-lambda-dynamodb.md), [17](17-serverless-contact-form-lambda-ses.md))
- Phase 7 — Observability & Cost ([18](18-observability-and-cost.md))
- Phase 8 — Productionizing ([19](19-cicd-github-actions.md), [20](20-teardown-and-interview-story.md))
