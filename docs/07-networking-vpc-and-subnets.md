...
`validate` = check that your config is **syntactically valid** and that all
references resolve. Catches typos like `aws_vpc.main.idd` (extra 'd') before
you waste 5 minutes apply'ing. Does not touch AWS — purely local.
